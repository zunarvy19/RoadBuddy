    ...
    <div class="mt-20">
        ...
        <section class="bg-white border rounded-lg">
            <div class=" px-4 py-8 mx-auto">
                <h2 class="mb-4 text-2xl font-bold text-gray-900 dark:text-white">Create Data BBM</h2>
                ...
                @method('POST')
                    <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                        <div class="sm:col-span-2 hidden">
                            ...
                            <input type="text" name="vendor_id" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " value="{{ old('name', $data->vendor_id) }}" placeholder="Nama Perusahaan" required="" @readonly(true)>
                        </div>
                        <div class="w-full">
