...
<section class="w-full">
  <div id="mainbar" class="fixed left-0 top-0 pt-16 w-full md:pl-64">
    <div class="px-4 md:px-8">
      <h1 class="text-start capitalize text-3xl py-5">Data Shell</h1>
      ...
      <div class="mt-20">
        ...
        <div class="flex justify-between items-center ">
            <div class="flex flex-col">
                <h1 class="text-3xl" >Data Shell</h1>
...
<thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
    <tr>
        ...
        <th scope="col" class="px-4 py-1">Jenis BBM</th>
        <th scope="col" class="px-4 py-4 ">Harga BBM</th> 
...
<tbody>
    ...
    <tr class="border-b dark:border-gray-700">
        ...
        <td class="px-4 py-3 capitalize">{{$data->jenis_bbm}}</td>
        <td class="px-4 py-3"> Rp. {{ number_format($data->harga_bbm, 0) }}</td>
        <td class="px-4 py-3">
            <ul class=" text-sm flex flex-col md:flex-row items-center justify-center" aria-labelledby="apple-imac-27-dropdown-button">
                ...
                <li>
                    <form action="{{ route('user.history.destroy', $data->id) }}" method="POST" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">
                        @csrf
                        @method('DELETE')
